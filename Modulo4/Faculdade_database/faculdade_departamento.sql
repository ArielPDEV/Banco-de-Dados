...
CREATE TABLE `departamento` (
  ...
  `prof_chef_cpf` varchar(100) NOT NULL,
...
INSERT INTO `departamento` VALUES (1,'Ciência da Computação','11122233344','Bloco A'),(2,'Engenharia Elétrica','55566677788','Bloco B');
