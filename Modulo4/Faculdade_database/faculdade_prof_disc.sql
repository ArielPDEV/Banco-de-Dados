...
CREATE TABLE `prof_disc` (
  ...
  PRIMARY KEY (`nome_disciplina`,`prof_cpf`),
  KEY `prof_cpf` (`prof_cpf`),
  CONSTRAINT `prof_disc_ibfk_1` FOREIGN KEY (`prof_cpf`) REFERENCES `professor` (`cpf`),
  CONSTRAINT `prof_disc_ibfk_2` FOREIGN KEY (`nome_disciplina`) REFERENCES `disciplina` (`nome`)
...
INSERT INTO `prof_disc` VALUES ('Banco de Dados I','11122233344'),('Banco de Dados II','11122233344'),('Programação I','55566677788');
